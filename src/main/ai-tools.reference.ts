    ...
    input_schema: {
      ...
      properties: {
        command: {
          type: 'string',
          description:
            "Git command with arguments (without 'git' prefix). E.g., 'pull origin main', 'checkout -b feature/new'"
        },
        cwd: {
          type: 'string',
  ...
  // ==========================================
  {
    ...
    input_schema: {
      ...
      properties: {
        action: {
          type: 'string',
          enum: ['lint', 'format', 'typecheck', 'complexity', 'dependencies']
        },
  ...
  // ==========================================
  {
    ...
    input_schema: {
      ...
      properties: {
        ...
        tool: {
          type: 'string',
          enum: ['prisma', 'typeorm', 'knex', 'sequelize', 'drizzle'],
...
async function executeGit(_input: Record<string, unknown>): Promise<ToolResult> {
...
async function executeFile(_input: Record<string, unknown>): Promise<ToolResult> {
  // TODO: Implement using fs/promises
  return { success: false, error: 'Not implemented' }
}

async function executeShell(_input: Record<string, unknown>): Promise<ToolResult> {
  // TODO: Implement using child_process
  return { success: false, error: 'Not implemented' }
}

async function executeGitHub(_input: Record<string, unknown>, _token: string): Promise<ToolResult> {
  // TODO: Implement using existing GitHub GraphQL client
  return { success: false, error: 'Not implemented' }
}

async function executePackage(_input: Record<string, unknown>): Promise<ToolResult> {
  // TODO: Implement npm/yarn/pnpm commands
  return { success: false, error: 'Not implemented' }
}

async function executeSearch(_input: Record<string, unknown>): Promise<ToolResult> {
  // TODO: Implement using ripgrep or similar
  return { success: false, error: 'Not implemented' }
}

async function executeAnalyze(_input: Record<string, unknown>): Promise<ToolResult> {
  // TODO: Implement lint/format/typecheck
  return { success: false, error: 'Not implemented' }
}

async function executeTest(_input: Record<string, unknown>): Promise<ToolResult> {
  // TODO: Implement test runner detection and execution
  return { success: false, error: 'Not implemented' }
}

async function executeDocker(_input: Record<string, unknown>): Promise<ToolResult> {
  // TODO: Implement docker commands
  return { success: false, error: 'Not implemented' }
}

async function executeHttp(_input: Record<string, unknown>): Promise<ToolResult> {
  // TODO: Implement using fetch
  return { success: false, error: 'Not implemented' }
}

async function executeEnv(_input: Record<string, unknown>): Promise<ToolResult> {
  // TODO: Implement environment variable management
  return { success: false, error: 'Not implemented' }
}

async function executeProcess(_input: Record<string, unknown>): Promise<ToolResult> {
  // TODO: Implement background process management
  return { success: false, error: 'Not implemented' }
}

async function executeDatabase(_input: Record<string, unknown>): Promise<ToolResult> {
...
async function executeJira(
  ...
  _config?: ToolExecutionContext['jiraConfig']
): Promise<ToolResult> {
  // TODO: Implement Jira API calls
  return { success: false, error: 'Not implemented' }
}

async function executeClipboard(_input: Record<string, unknown>): Promise<ToolResult> {
  // TODO: Implement using electron clipboard API
  return { success: false, error: 'Not implemented' }
}

async function executeBrowser(_input: Record<string, unknown>): Promise<ToolResult> {
