...
## 🔄 Architecture Migration (January 2026)

**Major Change:** The codebase was migrated from a custom signals-based state management system to **TanStack Query for ALL state**.
...
- ✅ Simpler mental model (useQuery/useMutation)
- ✅ No custom state management code to maintain
