...
const DialogOverlay: ForwardRefComponent<
...
const DialogContent: ForwardRefComponent<
...
const DialogTitle: ForwardRefComponent<
...
const DialogDescription: ForwardRefComponent<
